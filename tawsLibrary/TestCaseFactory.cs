...
namespace tawsLibrary
{
    public class TestCaseFactory
    {
        public string insertTestCase(ITestCaseModelBase testCase)
        {
            ...
            int projectCount = dbIo.ExeSqlUseNpgsql($"SELECT * FROM test_case_t WHERE test_case_no like '{ testCase.projectNo }%';");
            ...
            //データベースにINSERTする
            int[] result = dbIo.ExeSql2UseNpgsql(insTestCase, insTestCaseDetail);
